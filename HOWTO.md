How to run your own Electrum Darkcoin Server
============================================
...
The most up-to date version of this document is available at:
    ...
    https://github.com/mazaclub/electrum-dash-server/blob/master/HOWTO.md
...
If you already have a freshly indexed copy of the blockchain with txindex start `darkcoind`:
...
We will download the latest git snapshot for Electrum to configure and install it:
    ...
    $ cd ~
    $ git clone https://github.com/mazaclub/electrum-dash-server.git
    $ cd electrum-dash-server/src/darkcoin_hash
...
Darkcoin Electrum reads a config file (/etc/electrum-dash.conf) when starting up. This
...
2. Consider restarting darkcoind (together with electrum-dash-server) on a weekly basis to clear out unconfirmed
